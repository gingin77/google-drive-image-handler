...
fs.readFile("./credentials.json", (err, content) => {
  ...
  // Authorize a client with credentials, then call the Google Drive Activity API
  // Add params as a third argument passed to authorize, so that these can be customized
